...
public class Casilla {
    ...
    public String infoCasilla(Jugador banca) {
        ...
        if (getTipo().equals("solar")) {
            ...
            output.append("- Bote en parking: ").append(banca.getFortuna()).append("\n");
        }

        if (getduenhoJugador() != banca) {
    ...
    // Devuelve el dueño de la casilla, o null si no tiene dueño.
    ...
    private float alquilerEdificios() {
        float alquiler = 0;
